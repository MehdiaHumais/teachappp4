...
const TestSimple = () => {
  ...
  console.log("TestSimple: Component rendering. User:", user, "Loading:", loading); // Debug log

  // Check user role immediately (this should happen after context is initialized)
  if (loading) {
    console.log("TestSimple: Context still loading..."); // Debug log
    return (
  ...
  if (user?.role !== 'Admin') {
    console.log("TestSimple: Access denied check. User role:", user?.role); // Debug log
    return (
      <div className="full-screen bg-dark flex items-center justify-center">
        <div className="text-center">
  ...
  console.log("TestSimple: User is admin, showing content..."); // Debug log
  ...
  return (
    <div className="full-screen bg-dark flex flex-col">
      <div className="p-4 flex-grow overflow-y-auto">
        ...
        <button
          onClick={() => console.log("TestSimple: Button clicked!")}
